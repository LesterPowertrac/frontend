      ...
      <table style={{width: '100%', border:' 1px solid #dddddd'}} >
        <tbody>
          <tr>
            ...
            <td style={{border:' 1px solid #dddddd',}} colSpan={'4'}><label htmlFor='date1'>Date1:</label><input style={{width: '65%'}} type="date" id="date1"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date2'>Date2:</label><input style={{width: '65%'}} type="date" id="date2"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date3'>Date3:</label><input style={{width: '65%'}} type="date" id="date3"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date4'>Date4:</label><input style={{width: '65%'}} type="date" id="date4"/></td>
          </tr>
          <tr>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'4'}><label htmlFor='date5'>Date1:</label><input style={{width: '65%'}} type="date" id="date5"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date6'>Date2:</label><input style={{width: '65%'}} type="date" id="date6"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date7'>Date3:</label><input style={{width: '65%'}} type="date" id="date7"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date8'>Date4:</label><input style={{width: '65%'}} type="date" id="date8"/></td>
          </tr>
          <tr>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'4'}><label htmlFor='date9'>Date1:</label><input style={{width: '65%'}} type="date" id="date9"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date10'>Date2:</label><input style={{width: '65%'}} type="date" id="date10"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date11'>Date3:</label><input style={{width: '65%'}} type="date" id="date11"/></td>
            <td style={{border:' 1px solid #dddddd',}} colSpan={'3'}><label htmlFor='date12'>Date4:</label><input style={{width: '65%'}} type="date" id="date12"/></td>
          </tr>
          <tr>
            <td style={{border:' 1px solid #dddddd'}} colSpan={'4'}>Technician Name:</td>
            <td style={{border:' 1px solid #dddddd'}} colSpan={'3'}>Technician Name:</td>
            <td style={{border:' 1px solid #dddddd'}} colSpan={'3'}>Technician Name:</td>
            <td style={{border:' 1px solid #dddddd'}} colSpan={'3'}>Technician Name:</td>
          </tr>
          <tr >
